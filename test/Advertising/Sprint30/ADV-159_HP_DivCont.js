...
const { HP_URL_P } = require('./urls');
const { HP_URL_S } = require('./urls');
...
(async () => {
  ...
  //#region capture fullpage screenshot
    await page1.screenshot({ 
      path: `Prod-ADV-159_HP_DivCont-${browsertype}.png`,
      fullPage : true });
    console.log('Screenshot captured on ' + browsertype + ' browser!');

    await page2.screenshot({ 
      path: `Stage-ADV-159_HP_DivCont-${browsertype}.png`,
      fullPage : true });
    console.log('Screenshot captured on ' + browsertype + ' browser!');
  //#endregion
