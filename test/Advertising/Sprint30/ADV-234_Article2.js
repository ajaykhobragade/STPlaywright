...
const { LazyLoad_Article2_URL_S } = require('./urls');

(async () => {

  //#region launch browser, context and page
  const urls = [
    //{name: 'prod', link: Article_URL_P}, 
    {name: 'stage', link: LazyLoad_Article2_URL_S}];
...
//#endregion
  ...
  //#region capture fullpage screenshot
      await page.screenshot({ 
        path: url.name + `-ADV-234_Article2-${browsertype}.png`,
        fullPage : true });
