...
(async () => {
  ...
  await page1.goto('https://www.startribune.com/coronavirus-covid-19-minnesota-tracker-map-county-data/568712601/?featureOff=Bounce-X&debug=true', {
        waitUntil: 'load',
        timeout: 0
      });
  ...
  await page2.goto('https://stage-www.startribune.com/coronavirus-covid-19-minnesota-tracker-map-county-data/568712601/?featureOff=Bounce-X&debug=true', {
        waitUntil: 'load',
        timeout: 0
      });
