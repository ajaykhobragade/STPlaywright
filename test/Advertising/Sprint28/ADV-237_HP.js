...
(async () => {
  ...
  await page1.goto('https://www.startribune.com/?featureOff=Bounce-X&debug=true', {
        waitUntil: 'load',
        timeout: 0
      });
  ...
  await page2.goto('https://stage-www.startribune.com/?featureOff=Bounce-X&debug=true', {
        waitUntil: 'load',
        timeout: 0
      });
