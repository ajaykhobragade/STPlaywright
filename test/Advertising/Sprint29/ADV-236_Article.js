...
const { LazyLoad_URL_P } = require('./urls');
const { LazyLoad_URL_S } = require('./urls');
...
(async () => {
  ...
  //#region navigate to the pages
    await page1.goto(LazyLoad_URL_P, {
        waitUntil: 'load',
        timeout: 0
      });
  ...
  //#endregion
    ...
    await page2.goto(LazyLoad_URL_S, {
        waitUntil: 'load',
        timeout: 0
      });
  ...
  //#region capture fullpage screenshot
    await page1.screenshot({ 
      path: `ADV-236_Article-${browsertype}.png`,
      fullPage : true });
