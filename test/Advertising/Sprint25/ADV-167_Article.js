...
(async () => {
  ...
  //#region navigate to the pages
    await page1.goto('https://www.startribune.com/coronavirus-covid-19-minnesota-tracker-map-county-data/568712601/?featureOff=Bounce-X', {
        waitUntil: 'load',
        timeout: 0
      });
    ...
    await page2.goto('https://stage-www.startribune.com/coronavirus-covid-19-minnesota-tracker-map-county-data/568712601/?featureOff=Bounce-X', {
        waitUntil: 'load',
        timeout: 0
      });
  ...
  //#region capture fullpage screenshot
    await page1.screenshot({ 
      path: `ADV-167_Article-${browsertype}.png`,
      fullPage : true });
