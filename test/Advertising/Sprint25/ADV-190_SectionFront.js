...
(async () => {
  ...
  const urls = [
    { name: 'prod', link: 'https://www.startribune.com/local/?featureOff=Bounce-X'}, 
    {name: 'stage', link: 'https://stage-www.startribune.com/local/?featureOff=Bounce-X'}];
  ...
  //#region capture fullpage screenshot
      await page.screenshot({ 
        path: url.name + `-ST_SectionFront-${browsertype}.png`,
        fullPage : true });
