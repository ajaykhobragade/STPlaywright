...
(async () => {
  ...
  const urls = [
    { name: 'prod', link: 'https://www.startribune.com/trump-lashes-out-at-fauci-amid-criticism-of-slow-virus-response/569585832/?featureOff=Bounce-X'}, 
    {name: 'stage', link: 'https://stage-www.startribune.com/trump-lashes-out-at-fauci-amid-criticism-of-slow-virus-response/569585832/?featureOff=Bounce-X'}];
  ...
  //#region capture fullpage screenshot
      await page.screenshot({ 
        path: url.name + `-ST_ArticleGrazer2-${browsertype}.png`,
        fullPage : true });
