...
describe("Test visa disclaimer for desktop", () => {
  ...
  for (const browsertype of ['chromium']) {
    ...
    await page.goto("https://users.startribune.com/placement/1/environment/2/limit-visa-compliance-627/start?offer=627", {
        waitUntil: 'load',
        timeout: 0
    });
